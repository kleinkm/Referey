...
/**
 * Modified further for use with Referey by Karl Martin Klein
 */
...
public class NumberPicker extends LinearLayout implements OnClickListener,
    ...
    private static final int DEFAULT_MAX = 2020;
    private static final int DEFAULT_MIN = 1800;
    ...
    protected void changeCurrent(int current) {
        ...
        if (current > mEnd) {
            current = mEnd; //modified = mStart
        } else if (current < mStart) {
            current = mStart; //modified =mEnd
        }
        mPrevious = mCurrent;
        mCurrent = current;
